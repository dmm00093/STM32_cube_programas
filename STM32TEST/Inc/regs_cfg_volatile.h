...
// Necesitamos poner volatile en TODOS los punteros.
// Solo encendemos la variable y luego apagamos sin leerla entre medias.
// Sin volatiles el compilador las borra.

#define RCC_BASE_ADDR 0x40021000 // Definimos cte de direccion del registro RCC (pag 50).
#define RCC ((volatile RCC_TypeDef *) RCC_BASE_ADDR) // Puntero para acceder a todos los RCC (primer struct).
...
#define USART1 ((volatile USART_TypeDef *) USART1_BASE_ADDR)
#define USART2 ((volatile USART_TypeDef *) USART2_BASE_ADDR)
...
#define GPIOD ((volatile GPIO_TypeDef*) GPIOD_BASE_ADDR)
#define GPIOE ((volatile GPIO_TypeDef*) GPIOE_BASE_ADDR)
#define GPIOF ((volatile GPIO_TypeDef*) GPIOF_BASE_ADDR)
#define GPIOG ((volatile GPIO_TypeDef*) GPIOG_BASE_ADDR)
